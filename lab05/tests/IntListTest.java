...
public class IntListTest {
    ...
    public void testCatenate() {
        ...
        IntList expected = IntList.of(1, 2, 3, 4);

        assertThat(IntList.catenate(A, B)).isEqualTo(expected);
        assertThat(A).isEqualTo(IntList.of(1, 2));
    ...
    public void testDCatenate() {
        ...
        assertThat(result).isEqualTo(IntList.of(1, 2, 3, 4));
    }
}
