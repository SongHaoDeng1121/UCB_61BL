...
public class IntList {
    ...
    public void add(int value) {
        // TODO: YOUR CODE HERE
        if (this.next == null){
            this.next = new IntList(value,null);
        }
        else {
            this.next.add(value);
        }
    ...
    public int smallest() {
        ...
        int minRest = this.next.smallest();
        return Math.min(this.item, minRest);
    }
    ...
    public int squaredSum() {
        ...
        int Square_Sum = this.next.squaredSum();
        return Square_Sum+this.item*this.item;
    }
