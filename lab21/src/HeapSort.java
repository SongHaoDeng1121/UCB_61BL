public class HeapSort {
    ...
    public static void sort(int[] arr) {
        ...
        // Step 2: Repeatedly swap root with the last element in the heap
        for (int end = n - 1; end > 0; end--) {
            swap(arr, 0, end); // move max to end
            bubbleDown(arr, 0, end); // re-heapify the reduced heap
        }
    ...
    private static void heapify(int[] arr) {
        ...
        int n = arr.length;
        // Start from the last parent node and bubble down to fix the heap
