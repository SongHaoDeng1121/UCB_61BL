...
public class BinaryTree<T> {
    ...
    public boolean Balancehelper (TreeNode<T> node){
//        if (node == null){
//            return true;
//        }
        int leftheight = heighthelper(node.left);
    ...
    public static BinaryTree<Integer> fibTree(int N) {
        ...
        root = BinaryTree.fibTreeHelper(N);

        result = new BinaryTree<>(root);
    ...
    public static TreeNode<Integer> fibTreeHelper(int N){
        ...
        TreeNode<Integer> N1 =  new TreeNode<Integer>(0);
        N1.left = fibTreeHelper(N-1);
        N1.right = fibTreeHelper(N-2);
        N1.item = N1.left.item + N1.right.item;
        return N1;
    }
}
