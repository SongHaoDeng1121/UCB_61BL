...
public class Tileset {
    public static final TETile AVATAR =
            new TETile('♟', new Color(255, 215, 0), Color.BLUE, "you", 0);
    ...
    public static final TETile LOCKED_DOOR =
            new TETile('⚿', Color.orange, Color.black, "locked door", 7);
    ...
    public static final TETile ADVERSARY = new TETile('☠', Color.CYAN, Color.black, "adversary", 13);
    ...
    public static final TETile HEALTH_POTION = new TETile('♥', Color.RED, Color.BLACK, "health potion", 23);
}
