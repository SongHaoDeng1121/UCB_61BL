...
public class PreconditionTest {
    ...
    private static Class<?> getLldInnerClass() {
        Class<?>[] innerClasses = LinkedListDeque61BTest.class.getDeclaredClasses();
    ...
    public void genericTest() {
        Class<?> lldClass = LinkedListDeque61BTest.class;
        ...
        LinkedListDeque61BTest<Integer> lld = new LinkedListDeque61BTest<>();
    ...
    public void noNonTrivialFieldsTest() {
        Class<?> nodeClass = getLldInnerClass();
        Stream<Field> badLldFields = getBadFields(LinkedListDeque61BTest.class, nodeClass);
    ...
    public void noNonTrivialConstructorsTest() {
        Constructor<?>[] ctors = LinkedListDeque61BTest.class.getConstructors();
